# Here we will try to return all the data in the config yaml
...
# Importing dataingestion from config entity
...
# Importing dataValidation from config entity - here it returns all the 4 variable that i need 
