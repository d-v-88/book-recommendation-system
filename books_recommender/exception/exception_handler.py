# exception handling is important so custom exception is important. this is customized exception. if there is any error it returns back the line and all

# The entire project is huge so there might come a lot of error while coding and debugging it would be difficult this code helps to get the error and the exact line and file the eroor occured
